                                                                 ...
                                                                 CSE_PHSkeleton(caSection)
{
	...
	m_start_dialog = "";
	m_coop_active_slot = 0; // NO_ACTIVE_SLOT
}
...
void CSE_ALifeHumanStalker::UPDATE_Write(NET_Packet& tNetPacket)
{
	...
	tNetPacket.w_u8(m_coop_active_slot); // MP fork (§19 co-op): see the header
}
...
void CSE_ALifeHumanStalker::UPDATE_Read(NET_Packet& tNetPacket)
{
	...
	m_coop_active_slot = tNetPacket.r_u8(); // MP fork (§19 co-op): see the header
}
