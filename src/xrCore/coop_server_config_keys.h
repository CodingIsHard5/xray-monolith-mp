...
static const coop_cfg_key coop_server_config_keys[] = {
	...
	{"coop_reach_wait", coop_cfg_switch, coop_cfg_control},   // off | server | Gamedata mp_coop_reach_wait (PROTOTYPE): an online squad near a player whose target is on another map waits via GAMMA's fake_target instead of being held idle by the engine.
